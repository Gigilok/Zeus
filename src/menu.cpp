...
extern struct DroneLocation { float distance; int8_t rssi; };
...
extern struct PinTest { const char* name; bool working; };
extern PinTest* getPinTest(uint8_t);
extern void testModules(bool, bool, bool);
extern uint8_t getModuleCount();
extern struct ModuleStatus { const char* name; bool connected; bool working; };
